...
redirect_from:
  - /silverlight-101-presentation-and-files-from-net-university-west-michigan-2009/
---
...
[![](http://dodn.org/WestMichiganDotNetU/images/Site-Badge-I.gif)](http://dodn.org/WestMichiganDotNetU/) So, in summary, attached are the files from the Silverlight 101 presented by Bruce Abernethy and *Dan Woolston* (link is no longer active) session from [West Michigan .NET University 2009](http://dodn.org/WestMichiganDotNetU/).

- *Solution without movie, images, etc., 5Mb* *{missing-file:SL101.NETU.CODE.zip}*
- *Entire solution, files, sample movie, 70Mb* *{missing-file:SL101.NETU.zip}*
...
- *Silverlight Contrib* (link is no longer active) (merging with Silverlight Extensions)
- [Silverlight Toolkit](http://www.codeplex.com/Silverlight)
- *WPF Toolkit* (link is no longer active)
