...
- Encourage developers to attend _a **local Nerd Dinner**_ (link is no longer active) to get in touch with other local developers. If you don't have Nerd Dinners, create one.
- Have *all* your developers attend your _local **.NET User Group**_ (link is no longer active). Go one further and get them to present.
