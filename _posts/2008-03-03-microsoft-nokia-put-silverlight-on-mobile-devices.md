...
I am eager to see how this plays out, but it looks like now software developed in Silverlight [will be able to run](http://www.informationweek.com/news/showArticle.jhtml?articleID=206901441#community) on Nokia Series 40 and S60 phones (which is *quite a few phones* (link is no longer active) by the way).
