...
2) Preparation Materials – nada, there are no online learning, books or practice tests that I could find yet – by the time these get out we’ll be at Silverlight 5 – bummer3) The guys at Silverlight Show did a g[ood 7-part blog series](http://www.silverlightshow.net/items/Getting-ready-for-the-exams-Part-1.aspx) on preparing for the test – this was quite helpful to review. They have been going over a prep guide for 70-599 (WP7) test as well which I plan to read and take soon.I am debating my next test, but I do have a summer goal of taking one more – probably WCF to fill out the MCPD certification. Anyone who is interested in the WCF or WP7 tests, that wants to study together (online or in person), let me know in the next couple weeks.